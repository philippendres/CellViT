...
from cellvit.cell_segmentation.experiments.experiment_cpp_net_pannuke import (
    ExperimentCellViTCPP,
)

from cellvit.cell_segmentation.inference.inference_cpp_net_experiment_pannuke import (
    InferenceCellViTCPP,
)
